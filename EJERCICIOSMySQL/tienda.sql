...
LIMIT 1;
# 16. Lista el nombre de los productos que tienen un
#	  precio menor o igual a $120.
SELECT nombre, precio
FROM tienda.producto
WHERE precio <= 120;
...
# 18. Lista todos los productos donde el código de fabricante sea 1, 3 o 5.
#		Utilizando el operador IN.
SELECT *
FROM tienda.producto
WHERE codigo_fabricante IN (1,3,5);
# 23. Devuelve una lista con el nombre de todos los productos que contienen
...
#6. Devuelve un listado con todos los productos de los fabricantes 
#	Asus, Hewlett-Packard. Utilizando el operador IN.
SELECT p.nombre,p.precio,f.nombre
FROM producto p, fabricante f
...
SELECT  *, MAX(p.precio) as 'MAX PRECIO'
FROM fabricante f, producto p
WHERE f.nombre LIKE '%Lenovo%' AND p.codigo_fabricante = f.codigo;
...
AND f.nombre like '%Asus%' AND f.codigo = p.codigo_fabricante;
